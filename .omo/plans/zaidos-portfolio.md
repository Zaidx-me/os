...
- [ ] 1. Scaffold the Next.js 16 repo in /config/workspace/portfolio
...
- [ ] 2. Design tokens + global styles (Tailwind v4 CSS-first)
...
- [ ] 12. Window manager store + hotkey service
